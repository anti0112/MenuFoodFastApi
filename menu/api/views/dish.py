...
@router.get("/", tags=["Dish"], description=DishDocs.GET_LIST,
            summary=DishDocs.GET_LIST, response_model=list[DishOut]
            )
...
@router.get("/{dish_id}", tags=["Dish"], description=DishDocs.GET_DETAIL,
            summary=DishDocs.GET_DETAIL, response_model=DishOut
            )
...
@router.post("/", tags=["Dish"], description=DishDocs.POST_CREATE,
             summary=DishDocs.POST_CREATE, response_model=DishOut, status_code=201
             )
...
@router.patch("/{dish_id}", tags=["Dish"], description=DishDocs.PATCH_UPDATE,
              summary=DishDocs.PATCH_UPDATE, response_model=DishOut
              )
...
@router.delete("/{dish_id}", tags=["Dish"], description=DishDocs.DELETE, summary=DishDocs.DELETE)
