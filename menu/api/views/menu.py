...
@router.get("/", tags=["Menu"], description=MenuDocs.GET_LIST,
            summary=MenuDocs.GET_LIST, response_model=list[MenuOut]
            )
...
@router.post("/", tags=["Menu"], description=MenuDocs.POST_CREATE,
             summary=MenuDocs.POST_CREATE, response_model=MenuOut, status_code=201
             )
...
@router.get("/{menu_id}", tags=["Menu"], description=MenuDocs.GET_DETAIL,
            summary=MenuDocs.GET_DETAIL, response_model=MenuOut
            )
...
@router.patch("/{menu_id}", tags=["Menu"], description=MenuDocs.PATCH_UPDATE,
              summary=MenuDocs.PATCH_UPDATE, response_model=MenuOut
              )
...
@router.delete("/{menu_id}", tags=["Menu"], description=MenuDocs.DELETE, summary=MenuDocs.DELETE)
