...
class TestDishes:
    ...
    async def test_empty_dishes(self, async_client, base_url, event_loop):
        response = await async_client.get(base_url)
        assert response.status_code == 200
        expected_answer = []
        assert expected_answer == response.json()

    async def test_dish_create(self, async_client, async_session, base_url, event_loop):
        new_dish = {
            "title": "My dish 1",
            "description": "My dish description 1",
            "price": 12.50
    ...
    async def test_detailed_dish(self, async_client, event_loop, base_url):
        new_dish = {
            "title": "My dish 1",
            "description": "My dish description 1",
            "price": 12.50
    ...
    async def test_detailed_dish_invalid(self, async_client, event_loop, base_url):
        new_dish = {
            "title": "My dish 1",
            "description": "My dish description 1",
            "price": 12.50
    ...
    async def test_delete_dish(self, async_client, event_loop, base_url):
        new_dish = {
            "title": "My dish 1",
            "description": "My dish description 1",
            "price": 12.50
    ...
    async def test_delete_dish_invalid(self, async_client, event_loop, base_url):
        new_dish = {
            "title": "My dish 1",
            "description": "My dish description 1",
            "price": 12.50
    ...
    async def test_patch_dish(self, async_client, event_loop, base_url):
        new_dish = {
            "title": "My dish 1",
            "description": "My dish description 1",
            "price": 12.50
    ...
    async def test_patch_dish_invalid(self, async_client, event_loop, base_url):
        new_dish = {
            "title": "My dish 1",
            "description": "My dish description 1",
            "price": 12.50
