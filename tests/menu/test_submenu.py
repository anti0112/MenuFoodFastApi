...
class TestSubmenu:
    ...
    async def base_url(self, async_client, event_loop):
    ...
    async def test_empty_submenus(self, async_client, event_loop, base_url):
        response = await async_client.get(base_url)
        assert response.status_code == 200
        expected_answer = []
        assert expected_answer == response.json()

    async def test_submenu_create(self, async_client, async_session, event_loop, base_url):
        new_submenu = {
            "title": "My submenu 1",
    ...
    async def test_detailed_submenu(self, async_client, event_loop, base_url):
        new_submenu = {
            "title": "My submenu 1",
            "description": "My submenu description 1"
        }
    ...
    async def test_detailed_submenu_invalid(self, async_client, event_loop, base_url):
        new_submenu = {
            "title": "My submenu 1",
            "description": "My submenu description 1"
        }
    ...
    async def test_delete_submenu(self, async_client, event_loop, base_url):
        new_submenu = {
            "title": "My submenu 1",
            "description": "My submenu description 1"
        }
    ...
    async def test_delete_submenu_invalid(self, async_client, event_loop, base_url):
        new_submenu = {
            "title": "My submenu 1",
            "description": "My submenu description 1"
        }
    ...
    async def test_patch_submenu(self, async_client, event_loop, base_url):
        new_submenu = {
            "title": "My submenu 1",
            "description": "My submenu description 1"
        }
    ...
    async def test_patch_submenu_invalid(self, async_client, event_loop, base_url):
        new_submenu = {
            "title": "My submenu 1",
            "description": "My submenu description 1"
        }
